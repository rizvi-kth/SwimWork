...
//        LauncherComp.scenario = SwimScenario2.simpleBoot(1234L);
        //LauncherComp.scenario = SwimScenarioJoin.simpleBoot(1234L);
        LauncherComp.scenario = SwimScenarioKill.simpleBoot(1234L); // Crashed with-in Kompics  
